...
for (let i = 0; i < artistsArray.length; i++) {
 let birthYear = parseInt(artistsArray[i].years);
  if (birthYear > 1900) {
    namesArray.push(artistsArray[i].name);
  }
}
return namesArray;
}
 ...
 * your browser will continuously remove artists from the array until 
 * there are none left. If you refresh your browser, the data will reset.  
*/
...
console.log(addArtist({id: 20, name: "Robert Jank", years: "1989-still alive!", genre: "Web Design", nationality: "American", bio: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."}));
...
function lotsOfArt(artistsArray){
  ...
  for (let i = 0; i < artistsArray.length; i++) {
    if (artistsArray[i].paintings >= 100) {
      paintedAmount.push(artistsArray[i].name);
    }
  }
  return paintedAmount;
}
